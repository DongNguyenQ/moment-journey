...
import 'package:moment_journey/src/features/entry/domain/entities/entry_media_entity.dart';
...
class EntryRepositoryImpl implements EntryRepository {
  ...
  Future<Either<Failure, List<EntryMediaEntity>>> getMedia() {
    final result = repositoryHanlder.repositoryAsyncHandler(() {
      return _localDataSource.getEntries();
    });
    return result as Future<Either<Failure, List<EntryMediaEntity>>>;
  }
}
